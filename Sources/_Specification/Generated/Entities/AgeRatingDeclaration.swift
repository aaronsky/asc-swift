...
public struct AgeRatingDeclaration: Codable, Hashable, Identifiable {
    ...
    public init(type: `Type` = .ageRatingDeclarations, id: String, attributes: Attributes? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
