...
public struct SubscriptionOfferCodePrice: Codable, Hashable, Identifiable {
    ...
    public init(type: `Type` = .subscriptionOfferCodePrices, id: String, relationships: Relationships? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
