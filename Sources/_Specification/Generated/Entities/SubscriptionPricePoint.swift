...
public struct SubscriptionPricePoint: Codable, Hashable, Identifiable {
    ...
    public init(type: `Type` = .subscriptionPricePoints, id: String, attributes: Attributes? = nil, relationships: Relationships? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
