...
public struct AppStoreVersionPhasedRelease: Codable, Hashable, Identifiable {
    ...
    public init(type: `Type` = .appStoreVersionPhasedReleases, id: String, attributes: Attributes? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
