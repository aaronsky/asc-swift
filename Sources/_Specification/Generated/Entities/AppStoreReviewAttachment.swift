...
public struct AppStoreReviewAttachment: Codable, Hashable, Identifiable {
    ...
    public init(type: `Type` = .appStoreReviewAttachments, id: String, attributes: Attributes? = nil, relationships: Relationships? = nil, links: ResourceLinks) {
        self.type = type
        self.id = id
