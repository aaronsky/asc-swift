...
extension Resources.V1 {
    ...
    public struct BuildBetaDetails {
        ...
        public func get(filterBuild: [String]? = nil, filterID: [String]? = nil, fieldsBuildBetaDetails: [FieldsBuildBetaDetails]? = nil, limit: Int? = nil, include: [Include]? = nil, fieldsBuilds: [FieldsBuilds]? = nil) -> Request<_Specification.BuildBetaDetailsResponse> {
            Request(method: "GET", url: path, query: makeGetQuery(filterBuild, filterID, fieldsBuildBetaDetails, limit, include, fieldsBuilds), id: "buildBetaDetails-get_collection")
        }
