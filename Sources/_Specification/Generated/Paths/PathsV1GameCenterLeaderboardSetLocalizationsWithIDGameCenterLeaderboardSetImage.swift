...
extension Resources.V1.GameCenterLeaderboardSetLocalizations.WithID {
    ...
    public struct GameCenterLeaderboardSetImage {
        ...
        public func get(fieldsGameCenterLeaderboardSetLocalizations: [FieldsGameCenterLeaderboardSetLocalizations]? = nil, fieldsGameCenterLeaderboardSetImages: [FieldsGameCenterLeaderboardSetImages]? = nil, include: [Include]? = nil) -> Request<_Specification.GameCenterLeaderboardSetImageResponse> {
