...
extension Resources.V1.Apps {
    ...
    public struct WithID {
        ...
        public func patch(_ body: _Specification.AppUpdateRequest) -> Request<_Specification.AppResponse> {
