...
extension Resources.V1.CiProducts.WithID {
    ...
    public struct AdditionalRepositories {
        ...
        public func get(filterID: [String]? = nil, fieldsScmGitReferences: [FieldsScmGitReferences]? = nil, fieldsScmProviders: [FieldsScmProviders]? = nil, fieldsScmRepositories: [FieldsScmRepositories]? = nil, limit: Int? = nil, include: [Include]? = nil) -> Request<_Specification.ScmRepositoriesResponse> {
            Request(method: "GET", url: path, query: makeGetQuery(filterID, fieldsScmGitReferences, fieldsScmProviders, fieldsScmRepositories, limit, include), id: "ciProducts-additionalRepositories-get_to_many_related")
        }
