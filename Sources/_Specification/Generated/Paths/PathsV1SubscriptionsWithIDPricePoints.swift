...
extension Resources.V1.Subscriptions.WithID {
    ...
    public struct PricePoints {
        ...
        public func get(filterTerritory: [String]? = nil, fieldsSubscriptionPricePoints: [FieldsSubscriptionPricePoints]? = nil, fieldsTerritories: [FieldsTerritories]? = nil, limit: Int? = nil, include: [Include]? = nil) -> Request<_Specification.SubscriptionPricePointsResponse> {
            Request(method: "GET", url: path, query: makeGetQuery(filterTerritory, fieldsSubscriptionPricePoints, fieldsTerritories, limit, include), id: "subscriptions-pricePoints-get_to_many_related")
        }
