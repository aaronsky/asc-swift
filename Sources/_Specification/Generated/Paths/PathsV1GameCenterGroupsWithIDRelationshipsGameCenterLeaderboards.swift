...
extension Resources.V1.GameCenterGroups.WithID.Relationships {
    ...
    public struct GameCenterLeaderboards {
        ...
        public func get(limit: Int? = nil) -> Request<_Specification.GameCenterGroupGameCenterLeaderboardsLinkagesResponse> {
        ...
        public func patch(_ body: _Specification.GameCenterGroupGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
