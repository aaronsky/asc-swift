...
extension Resources.V1.GameCenterLeaderboardSets {
    ...
    public struct WithID {
        ...
        public func patch(_ body: _Specification.GameCenterLeaderboardSetUpdateRequest) -> Request<_Specification.GameCenterLeaderboardSetResponse> {
