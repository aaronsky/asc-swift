...
extension Resources.V1.GameCenterMatchmakingRuleSets.WithID {
    ...
    public struct MatchmakingQueues {
        ...
        public func get(fieldsGameCenterMatchmakingQueues: [FieldsGameCenterMatchmakingQueues]? = nil, fieldsGameCenterMatchmakingRuleSets: [FieldsGameCenterMatchmakingRuleSets]? = nil, limit: Int? = nil, include: [Include]? = nil) -> Request<_Specification.GameCenterMatchmakingQueuesResponse> {
