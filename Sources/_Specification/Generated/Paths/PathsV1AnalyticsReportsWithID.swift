...
extension Resources.V1.AnalyticsReports {
    ...
    public struct WithID {
        ...
        public func get(fieldsAnalyticsReports: [FieldsAnalyticsReports]? = nil, fieldsAnalyticsReportInstances: [FieldsAnalyticsReportInstances]? = nil) -> Request<_Specification.AnalyticsReportResponse> {
