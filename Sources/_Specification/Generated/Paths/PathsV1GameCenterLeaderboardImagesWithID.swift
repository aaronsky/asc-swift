...
extension Resources.V1.GameCenterLeaderboardImages {
    ...
    public struct WithID {
        ...
        public func get(fieldsGameCenterLeaderboardImages: [FieldsGameCenterLeaderboardImages]? = nil, include: [Include]? = nil) -> Request<_Specification.GameCenterLeaderboardImageResponse> {
        ...
        public func patch(_ body: _Specification.GameCenterLeaderboardImageUpdateRequest) -> Request<_Specification.GameCenterLeaderboardImageResponse> {
