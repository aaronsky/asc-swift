...
extension Resources.V1 {
    ...
    public struct AlternativeDistributionDomains {
        ...
        public func get(fieldsAlternativeDistributionDomains: [FieldsAlternativeDistributionDomains]? = nil, limit: Int? = nil) -> Request<_Specification.AlternativeDistributionDomainsResponse> {
        ...
        public func post(_ body: _Specification.AlternativeDistributionDomainCreateRequest) -> Request<_Specification.AlternativeDistributionDomainResponse> {
