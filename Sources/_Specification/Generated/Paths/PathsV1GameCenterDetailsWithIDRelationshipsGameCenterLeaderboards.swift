...
extension Resources.V1.GameCenterDetails.WithID.Relationships {
    ...
    public struct GameCenterLeaderboards {
        ...
        public func get(limit: Int? = nil) -> Request<_Specification.GameCenterDetailGameCenterLeaderboardsLinkagesResponse> {
        ...
        public func patch(_ body: _Specification.GameCenterDetailGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
