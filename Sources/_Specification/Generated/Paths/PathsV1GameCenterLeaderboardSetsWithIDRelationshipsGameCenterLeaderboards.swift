...
extension Resources.V1.GameCenterLeaderboardSets.WithID.Relationships {
    ...
    public struct GameCenterLeaderboards {
        ...
        public func get(limit: Int? = nil) -> Request<_Specification.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesResponse> {
        ...
        public func post(_ body: _Specification.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "gameCenterLeaderboardSets-gameCenterLeaderboards-create_to_many_relationship")
        }

        public func patch(_ body: _Specification.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
        ...
        public func delete(_ body: _Specification.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
