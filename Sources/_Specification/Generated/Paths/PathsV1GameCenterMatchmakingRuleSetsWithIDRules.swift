...
extension Resources.V1.GameCenterMatchmakingRuleSets.WithID {
    ...
    public struct Rules {
        ...
        public func get(fieldsGameCenterMatchmakingRules: [FieldsGameCenterMatchmakingRules]? = nil, limit: Int? = nil) -> Request<_Specification.GameCenterMatchmakingRulesResponse> {
