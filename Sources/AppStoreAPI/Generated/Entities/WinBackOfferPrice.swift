...
public struct WinBackOfferPrice: Codable, Equatable, Identifiable, Sendable {
    ...
    public init(type: `Type` = .winBackOfferPrices, id: String, relationships: Relationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
