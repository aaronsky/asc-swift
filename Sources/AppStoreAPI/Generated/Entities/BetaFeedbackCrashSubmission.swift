...
public struct BetaFeedbackCrashSubmission: Codable, Equatable, Identifiable, Sendable {
    ...
    public struct Relationships: Codable, Equatable, Sendable {
        ...
        public struct CrashLog: Codable, Equatable, Sendable {
    ...
    public init(type: `Type` = .betaFeedbackCrashSubmissions, id: String, attributes: Attributes? = nil, relationships: Relationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
