...
public struct GameCenterAchievementV2CreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .gameCenterAchievements, attributes: Attributes, relationships: Relationships) {
            self.type = type
