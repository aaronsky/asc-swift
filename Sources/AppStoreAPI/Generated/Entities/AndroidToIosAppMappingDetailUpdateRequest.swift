...
public struct AndroidToIosAppMappingDetailUpdateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Identifiable, Sendable {
        ...
        public init(type: `Type` = .androidToIosAppMappingDetails, id: String, attributes: Attributes? = nil) {
            self.type = type
            self.id = id
