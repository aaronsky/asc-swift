...
public struct GameCenterLeaderboardSetV2CreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .gameCenterLeaderboardSets, attributes: Attributes, relationships: Relationships) {
            self.type = type
