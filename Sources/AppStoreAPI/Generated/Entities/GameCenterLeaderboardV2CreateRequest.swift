...
public struct GameCenterLeaderboardV2CreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .gameCenterLeaderboards, attributes: Attributes, relationships: Relationships) {
            self.type = type
