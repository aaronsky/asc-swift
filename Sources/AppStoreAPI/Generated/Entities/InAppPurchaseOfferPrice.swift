...
public struct InAppPurchaseOfferPrice: Codable, Equatable, Identifiable, Sendable {
    ...
    public init(type: `Type` = .inAppPurchaseOfferPrices, id: String, relationships: Relationships? = nil, links: ResourceLinks? = nil) {
        self.type = type
        self.id = id
