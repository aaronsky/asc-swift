...
public struct AndroidToIosAppMappingDetailCreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .androidToIosAppMappingDetails, attributes: Attributes, relationships: Relationships) {
            self.type = type
