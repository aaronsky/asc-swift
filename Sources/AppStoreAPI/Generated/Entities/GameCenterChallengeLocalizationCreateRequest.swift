...
public struct GameCenterChallengeLocalizationCreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .gameCenterChallengeLocalizations, attributes: Attributes, relationships: Relationships) {
            self.type = type
