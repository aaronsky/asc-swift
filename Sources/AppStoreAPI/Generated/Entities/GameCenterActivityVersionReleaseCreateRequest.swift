...
public struct GameCenterActivityVersionReleaseCreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .gameCenterActivityVersionReleases, relationships: Relationships) {
            self.type = type
