...
public struct MetricsInsight: Codable, Equatable, Sendable {
    ...
    public struct Population: Codable, Equatable, Sendable {
    ...
    public init(metricCategory: MetricCategories? = nil, latestVersion: String? = nil, metric: String? = nil, summaryString: String? = nil, referenceVersions: String? = nil, maxLatestVersionValue: Double? = nil, subSystemLabel: String? = nil, isHighImpact: Bool? = nil, populations: [Population]? = nil) {
