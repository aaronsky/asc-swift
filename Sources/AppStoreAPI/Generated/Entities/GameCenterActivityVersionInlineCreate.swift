...
public struct GameCenterActivityVersionInlineCreate: Codable, Equatable, Identifiable, Sendable {
    ...
    public init(type: `Type` = .gameCenterActivityVersions, id: String? = nil, attributes: Attributes? = nil, relationships: Relationships? = nil) {
        self.type = type
        self.id = id
