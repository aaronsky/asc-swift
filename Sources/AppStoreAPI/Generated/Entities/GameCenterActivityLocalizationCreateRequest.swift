...
public struct GameCenterActivityLocalizationCreateRequest: Codable, Equatable, Sendable {
    ...
    public struct Data: Codable, Equatable, Sendable {
        ...
        public init(type: `Type` = .gameCenterActivityLocalizations, attributes: Attributes, relationships: Relationships) {
            self.type = type
