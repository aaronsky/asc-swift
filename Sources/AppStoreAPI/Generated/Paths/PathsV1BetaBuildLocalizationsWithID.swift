...
extension Resources.V1.BetaBuildLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsBetaBuildLocalizations: [FieldsBetaBuildLocalizations]? = nil, include: [Include]? = nil, fieldsBuilds: [FieldsBuilds]? = nil) -> Request<AppStoreAPI.BetaBuildLocalizationResponse> {
