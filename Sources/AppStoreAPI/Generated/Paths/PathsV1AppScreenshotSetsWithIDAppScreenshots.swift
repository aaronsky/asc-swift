...
extension Resources.V1.AppScreenshotSets.WithID {
    ...
    public struct AppScreenshots {
        ...
        public func get(fieldsAppScreenshotSets: [FieldsAppScreenshotSets]? = nil, fieldsAppScreenshots: [FieldsAppScreenshots]? = nil, limit: Int? = nil, include: [Include]? = nil) -> Request<AppStoreAPI.AppScreenshotsResponse> {
