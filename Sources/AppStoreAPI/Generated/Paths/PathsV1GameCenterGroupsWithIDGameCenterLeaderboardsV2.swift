...
extension Resources.V1.GameCenterGroups.WithID {
    ...
    public struct GameCenterLeaderboardsV2 {
        ...
        public func get(filterReferenceName: [String]? = nil, filterArchived: [String]? = nil, filterID: [String]? = nil, fieldsGameCenterLeaderboards: [FieldsGameCenterLeaderboards]? = nil, fieldsGameCenterDetails: [FieldsGameCenterDetails]? = nil, fieldsGameCenterGroups: [FieldsGameCenterGroups]? = nil, fieldsGameCenterLeaderboardSets: [FieldsGameCenterLeaderboardSets]? = nil, fieldsGameCenterActivities: [FieldsGameCenterActivities]? = nil, fieldsGameCenterChallenges: [FieldsGameCenterChallenges]? = nil, fieldsGameCenterLeaderboardVersions: [FieldsGameCenterLeaderboardVersions]? = nil, limit: Int? = nil, include: [Include]? = nil, limitGameCenterLeaderboardSets: Int? = nil, limitVersions: Int? = nil) -> Request<AppStoreAPI.GameCenterLeaderboardsV2Response> {
            Request(path: path, method: "GET", query: makeGetQuery(filterReferenceName, filterArchived, filterID, fieldsGameCenterLeaderboards, fieldsGameCenterDetails, fieldsGameCenterGroups, fieldsGameCenterLeaderboardSets, fieldsGameCenterActivities, fieldsGameCenterChallenges, fieldsGameCenterLeaderboardVersions, limit, include, limitGameCenterLeaderboardSets, limitVersions), id: "gameCenterGroups_gameCenterLeaderboardsV2_getToManyRelated")
        }
