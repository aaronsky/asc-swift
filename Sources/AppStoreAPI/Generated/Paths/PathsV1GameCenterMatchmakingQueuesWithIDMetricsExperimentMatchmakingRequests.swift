...
extension Resources.V1.GameCenterMatchmakingQueues.WithID.Metrics {
    ...
    public struct ExperimentMatchmakingRequests {
        ...
        public func get(granularity: Granularity, groupBy: [GroupBy]? = nil, filterResult: FilterResult? = nil, filterGameCenterDetail: String? = nil, sort: [Sort]? = nil, limit: Int? = nil) -> Request<AppStoreAPI.GameCenterMatchmakingQueueRequestsV1MetricResponse> {
            Request(path: path, method: "GET", query: makeGetQuery(granularity, groupBy, filterResult, filterGameCenterDetail, sort, limit), id: "gameCenterMatchmakingQueues_experimentMatchmakingRequests_getMetrics")
        }
