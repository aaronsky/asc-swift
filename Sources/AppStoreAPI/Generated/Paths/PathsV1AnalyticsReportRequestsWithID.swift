...
extension Resources.V1.AnalyticsReportRequests {
    ...
    public struct WithID {
        ...
        public func get(fieldsAnalyticsReportRequests: [FieldsAnalyticsReportRequests]? = nil, include: [Include]? = nil, fieldsAnalyticsReports: [FieldsAnalyticsReports]? = nil, limitReports: Int? = nil) -> Request<AppStoreAPI.AnalyticsReportRequestResponse> {
