...
extension Resources.V1.AppStoreVersionExperimentTreatmentLocalizations.WithID {
    ...
    public struct AppScreenshotSets {
        ...
        public func get(filterScreenshotDisplayType: [FilterScreenshotDisplayType]? = nil, filterAppStoreVersionLocalization: [String]? = nil, filterAppCustomProductPageLocalization: [String]? = nil, fieldsAppScreenshotSets: [FieldsAppScreenshotSets]? = nil, fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations]? = nil, fieldsAppCustomProductPageLocalizations: [FieldsAppCustomProductPageLocalizations]? = nil, fieldsAppStoreVersionExperimentTreatmentLocalizations: [FieldsAppStoreVersionExperimentTreatmentLocalizations]? = nil, fieldsAppScreenshots: [FieldsAppScreenshots]? = nil, limit: Int? = nil, include: [Include]? = nil, limitAppScreenshots: Int? = nil) -> Request<AppStoreAPI.AppScreenshotSetsResponse> {
            Request(path: path, method: "GET", query: makeGetQuery(filterScreenshotDisplayType, filterAppStoreVersionLocalization, filterAppCustomProductPageLocalization, fieldsAppScreenshotSets, fieldsAppStoreVersionLocalizations, fieldsAppCustomProductPageLocalizations, fieldsAppStoreVersionExperimentTreatmentLocalizations, fieldsAppScreenshots, limit, include, limitAppScreenshots), id: "appStoreVersionExperimentTreatmentLocalizations_appScreenshotSets_getToManyRelated")
        }

        private func makeGetQuery(_ filterScreenshotDisplayType: [FilterScreenshotDisplayType]?, _ filterAppStoreVersionLocalization: [String]?, _ filterAppCustomProductPageLocalization: [String]?, _ fieldsAppScreenshotSets: [FieldsAppScreenshotSets]?, _ fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations]?, _ fieldsAppCustomProductPageLocalizations: [FieldsAppCustomProductPageLocalizations]?, _ fieldsAppStoreVersionExperimentTreatmentLocalizations: [FieldsAppStoreVersionExperimentTreatmentLocalizations]?, _ fieldsAppScreenshots: [FieldsAppScreenshots]?, _ limit: Int?, _ include: [Include]?, _ limitAppScreenshots: Int?) -> [(String, String?)] {
