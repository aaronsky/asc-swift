...
extension Resources.V1.Apps.WithID {
    ...
    public struct GameCenterEnabledVersions {
        ...
        public func get(filterPlatform: [FilterPlatform]? = nil, filterVersionString: [String]? = nil, filterID: [String]? = nil, sort: [Sort]? = nil, fieldsGameCenterEnabledVersions: [FieldsGameCenterEnabledVersions]? = nil, fieldsApps: [FieldsApps]? = nil, limit: Int? = nil, include: [Include]? = nil, limitCompatibleVersions: Int? = nil) -> Request<AppStoreAPI.GameCenterEnabledVersionsResponse> {
            Request(path: path, method: "GET", query: makeGetQuery(filterPlatform, filterVersionString, filterID, sort, fieldsGameCenterEnabledVersions, fieldsApps, limit, include, limitCompatibleVersions), id: "apps_gameCenterEnabledVersions_getToManyRelated")
        }

        private func makeGetQuery(_ filterPlatform: [FilterPlatform]?, _ filterVersionString: [String]?, _ filterID: [String]?, _ sort: [Sort]?, _ fieldsGameCenterEnabledVersions: [FieldsGameCenterEnabledVersions]?, _ fieldsApps: [FieldsApps]?, _ limit: Int?, _ include: [Include]?, _ limitCompatibleVersions: Int?) -> [(String, String?)] {
