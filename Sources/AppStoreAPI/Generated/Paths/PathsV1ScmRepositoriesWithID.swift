...
extension Resources.V1.ScmRepositories {
    ...
    public struct WithID {
        ...
        public func get(fieldsScmRepositories: [FieldsScmRepositories]? = nil, include: [Include]? = nil, fieldsScmGitReferences: [FieldsScmGitReferences]? = nil, fieldsScmPullRequests: [FieldsScmPullRequests]? = nil) -> Request<AppStoreAPI.ScmRepositoryResponse> {
