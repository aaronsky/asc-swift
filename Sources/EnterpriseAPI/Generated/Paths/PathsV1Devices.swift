...
extension Resources {
    ...
    public struct Devices {
        ...
        /// List Devices
        public func get(filterName: [String]? = nil, filterPlatform: [FilterPlatform]? = nil, filterStatus: [FilterStatus]? = nil, filterUdid: [String]? = nil, filterID: [String]? = nil, sort: [Sort]? = nil, fieldsDevices: [FieldsDevices]? = nil, limit: Int? = nil) -> Request<EnterpriseAPI.DevicesResponse> {
        ...
        public func post(_ body: EnterpriseAPI.DeviceCreateRequest) -> Request<EnterpriseAPI.DeviceResponse> {
