...
extension Resources.V1.InAppPurchaseAppStoreReviewScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsInAppPurchaseAppStoreReviewScreenshots: [FieldsInAppPurchaseAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect.InAppPurchaseAppStoreReviewScreenshotResponse> {
        ...
        public func patch(_ body: AppStoreConnect.InAppPurchaseAppStoreReviewScreenshotUpdateRequest) -> Request<AppStoreConnect.InAppPurchaseAppStoreReviewScreenshotResponse> {
