...
extension Resources.V1.SubscriptionPromotionalOffers {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect.SubscriptionPromotionalOfferResponse> {
        ...
        public func patch(_ body: AppStoreConnect.SubscriptionPromotionalOfferUpdateRequest) -> Request<AppStoreConnect.SubscriptionPromotionalOfferResponse> {
