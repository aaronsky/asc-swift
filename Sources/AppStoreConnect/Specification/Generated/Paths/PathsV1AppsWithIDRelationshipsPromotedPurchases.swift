...
extension Resources.V1.Apps.WithID.Relationships {
    ...
    public struct PromotedPurchases {
        ...
        public func get(limit: Int? = nil) -> Request<AppStoreConnect.AppPromotedPurchasesLinkagesResponse> {
        ...
        public func patch(_ body: AppStoreConnect.AppPromotedPurchasesLinkagesRequest) -> Request<Void> {
