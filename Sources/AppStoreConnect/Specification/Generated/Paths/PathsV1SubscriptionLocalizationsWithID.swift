...
extension Resources.V1.SubscriptionLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionLocalizations: [FieldsSubscriptionLocalizations]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect.SubscriptionLocalizationResponse> {
        ...
        public func patch(_ body: AppStoreConnect.SubscriptionLocalizationUpdateRequest) -> Request<AppStoreConnect.SubscriptionLocalizationResponse> {
