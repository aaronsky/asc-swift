...
extension Resources.V1.SubscriptionGroupLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionGroupLocalizations: [FieldsSubscriptionGroupLocalizations]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect.SubscriptionGroupLocalizationResponse> {
        ...
        public func patch(_ body: AppStoreConnect.SubscriptionGroupLocalizationUpdateRequest) -> Request<AppStoreConnect.SubscriptionGroupLocalizationResponse> {
