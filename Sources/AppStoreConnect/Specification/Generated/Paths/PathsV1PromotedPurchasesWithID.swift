...
extension Resources.V1.PromotedPurchases {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect.PromotedPurchaseResponse> {
        ...
        public func patch(_ body: AppStoreConnect.PromotedPurchaseUpdateRequest) -> Request<AppStoreConnect.PromotedPurchaseResponse> {
