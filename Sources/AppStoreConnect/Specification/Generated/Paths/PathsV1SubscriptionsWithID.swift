...
extension Resources.V1.Subscriptions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect.SubscriptionResponse> {
        ...
        public func patch(_ body: AppStoreConnect.SubscriptionUpdateRequest) -> Request<AppStoreConnect.SubscriptionResponse> {
