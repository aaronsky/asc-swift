...
extension Resources.V1.SubscriptionOfferCodes {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect.SubscriptionOfferCodeResponse> {
        ...
        public func patch(_ body: AppStoreConnect.SubscriptionOfferCodeUpdateRequest) -> Request<AppStoreConnect.SubscriptionOfferCodeResponse> {
