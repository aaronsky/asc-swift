...
extension Resources.V1.Subscriptions.WithID.Relationships {
    ...
    public struct Prices {
        ...
        public func get(limit: Int? = nil) -> Request<AppStoreConnect.SubscriptionPricesLinkagesResponse> {
        ...
        public func delete(_ body: AppStoreConnect.SubscriptionPricesLinkagesRequest) -> Request<Void> {
