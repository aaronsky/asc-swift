...
extension Resources.V1.SubscriptionAppStoreReviewScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionAppStoreReviewScreenshots: [FieldsSubscriptionAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect.SubscriptionAppStoreReviewScreenshotResponse> {
        ...
        public func patch(_ body: AppStoreConnect.SubscriptionAppStoreReviewScreenshotUpdateRequest) -> Request<AppStoreConnect.SubscriptionAppStoreReviewScreenshotResponse> {
